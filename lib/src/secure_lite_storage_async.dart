...
class SecureLiteStorageAsync {
  static final SecureLiteStorageAsync _instance =
      SecureLiteStorageAsync._internal();
  factory SecureLiteStorageAsync() => _instance;
  SecureLiteStorageAsync._internal();
  ...
  Future<void> init() async {
    ...
    _file = File(path.join(directory.path, 'storage3.sls'));
  ...
  Future<void> setString(String key, String value) async {
    await _setValue(key, Value()..stringValue = value);
  }
  ...
  Future<void> setInt(String key, int value) async {
    await _setValue(key, Value()..intValue = value);
  }
  ...
  Future<void> setDouble(String key, double value) async {
    await _setValue(key, Value()..doubleValue = value);
  }
  ...
  Future<void> setBool(String key, bool value) async {
    await _setValue(key, Value()..boolValue = value);
  }
  ...
  Future<void> setBytes(String key, List<int> value) async {
    await _setValue(key, Value()..bytesValue = value);
  }
